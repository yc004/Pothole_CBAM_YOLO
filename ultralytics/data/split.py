...
def split_classify_dataset(source_dir: str | Path, train_ratio: float = 0.8) -> Path:
    """Split classification datasets into train and val directories in a new directory.
...
def autosplit(
    ...
    """Automatically split a datasets into train/val/test splits and save the resulting splits into autosplit_*.txt
    files.
